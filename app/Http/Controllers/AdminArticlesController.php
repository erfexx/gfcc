<?php namespace App\Http\Controllers;
	...
	class AdminArticlesController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->col[] = ["label"=>"Synopsis","name"=>"synopsis"];
			...
			$this->form[] = ['label'=>'Synopsis','name'=>'synopsis','type'=>'textarea','validation'=>'required','width'=>'col-sm-10'];
			$this->form[] = ['label'=>'Thumbnail Path','name'=>'thumbnail_path','type'=>'upload','validation'=>'required|image','width'=>'col-sm-10'];
			$this->form[] = ['label'=>'Article Type','name'=>'article_type','type'=>'radio','validation'=>'required','width'=>'col-sm-10','dataenum'=>'Artikel;Renungan;Berita'];
